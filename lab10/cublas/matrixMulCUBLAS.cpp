...
void initializeCUDA(int argc, char **argv, int &devID, int &iSizeMultiple, sMatrixSize &matrix_size)
{
    ...
    const int matrix_size_multiplier = 1;
    iSizeMultiple = 256;
    matrix_size.uiWA = matrix_size_multiplier * block_size * iSizeMultiple;
    matrix_size.uiHA = matrix_size_multiplier * block_size * iSizeMultiple;
    matrix_size.uiWB = matrix_size_multiplier * block_size * iSizeMultiple;
    matrix_size.uiHB = matrix_size_multiplier * block_size * iSizeMultiple;
    matrix_size.uiWC = matrix_size_multiplier * block_size * iSizeMultiple;
    matrix_size.uiHC = matrix_size_multiplier * block_size * iSizeMultiple;
